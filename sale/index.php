...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_TIZERS_ID" => "55",
		"IBLOCK_LINK_REVIEWS_ID" => "54",
		"IBLOCK_LINK_STAFF_ID" => "73",
		"IBLOCK_LINK_VACANCIES_ID" => "46",
		"IBLOCK_LINK_PROJECTS_ID" => "61",
		"IBLOCK_LINK_BRANDS_ID" => "74",
		...
		"IBLOCK_LINK_SERVICES_ID" => "60",
		"IBLOCK_LINK_TIZERS_ID" => "55",
		"BLOCK_VACANCY_NAME" => "Вакансии",
		"BLOCK_BLOG_NAME" => "Статьи",
		"IBLOCK_LINK_VACANCY_ID" => "46",

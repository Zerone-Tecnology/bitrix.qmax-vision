...
<div class="bx_section i_or_section">
	<h4>
	...
	<div id="sale_order_props" <?=($bHideProps && $_POST["showProps"] != "Y")?"style='display:none;'":''?>>
		<?
		$UA = ($USER->IsAuthorized()) ? 'ua' : 'na';
		PrintPropsForm($arResult['I_ORDER_PROP'], $arParams['TEMPLATE_LOCATION'], $UA);
...
<?/*if($USER->isAdmin()):?>
	<pre><?print_r($arResult['I_ORDER_PROP'])?></pre>
<?endif*/?>
            ...
            <div class="profile-table data-table">
                <div class="profile-table-body">
					...
					if($arResult["ID"]>0)
					{
                        ...
                        <div class="profile-table-row">
                            <div class="profile-table-col">
								<span class="refreshed-time-data">
									<?if (strlen($arResult["arUser"]["TIMESTAMP_X"])>0)
										echo GetMessage('LAST_UPDATE')?> <?=$arResult["arUser"]["TIMESTAMP_X"].'&nbsp;&nbsp;&nbsp;&nbsp;';?>
								</span>
                                <span class="last-login-time-data">
									<?if (strlen($arResult["arUser"]["LAST_LOGIN"])>0)
										echo GetMessage('LAST_LOGIN')?> <?=$arResult["arUser"]["LAST_LOGIN"]?>
								</span>
                            </div>
                        </div>
						<?
					...
					?>
                    <div class="profile-table-row">
                        <div class="profile-table-col"><?=GetMessage('NAME')?></div>
                        <div class="profile-table-col"><input type="text" name="NAME" maxlength="50" value="<?=$arResult["arUser"]["NAME"]?>" /></div>
                    </div>
                    <div class="profile-table-row">
                        <div class="profile-table-col"><?=GetMessage('LAST_NAME')?></div>
                        <div class="profile-table-col"><input type="text" name="LAST_NAME" maxlength="50" value="<?=$arResult["arUser"]["LAST_NAME"]?>" /></div>
                    </div>
                    <div class="profile-table-row">
                        <div class="profile-table-col"><?=GetMessage('SECOND_NAME')?></font></div>
                        <div class="profile-table-col"><input type="text" name="SECOND_NAME" maxlength="50" value="<?=$arResult["arUser"]["SECOND_NAME"]?>" /></div>
                    </div>
                    <div class="profile-table-row" style="display: none">
                        <div class="profile-table-col"><?=GetMessage('EMAIL')?><?if($arResult["EMAIL_REQUIRED"]):?><span class="starrequired">*</span><?endif?></div>
                        <div class="profile-table-col"><input type="text" name="EMAIL" maxlength="50" value="<? echo $arResult["arUser"]["EMAIL"]?>" /></div>
                    </div>
					<div class="profile-table-row">
						<div class="profile-table-col"><?=GetMessage('EMAIL')?><span class="starrequired">*</span></div>
						<div class="profile-table-col"><input type="text" name="LOGIN" maxlength="50" value="<? echo $arResult["arUser"]["LOGIN"]?>" /></div>
					</div>
					<?if($arResult["arUser"]["EXTERNAL_AUTH_ID"] == ''):?>
                        <div class="profile-table-row">
                            <div class="profile-table-col"><?=GetMessage('NEW_PASSWORD_REQ')?></div>
                            <div class="profile-table-col"><input type="password" name="NEW_PASSWORD" maxlength="50" value="" autocomplete="off" class="bx-auth-input">
				...
				<span class="bx-auth-secure" title="<?echo GetMessage("AUTH_NONSECURE_NOTE")?>">
					<div class="bx-auth-secure-icon bx-auth-secure-unlock"></div>
                        ...
                        <div class="profile-table-row">
                            <div class="profile-table-col"><?=GetMessage('NEW_PASSWORD_CONFIRM')?></div>
                            <div class="profile-table-col"><input type="password" name="NEW_PASSWORD_CONFIRM" maxlength="50" value="" autocomplete="off" /></div>
                        </div>
					<?endif?>
					<?/*if($arResult["TIME_ZONE_ENABLED"] == true):?>
						<div class="profile-table-row">
							<div class="profile-table-col"><?echo GetMessage("main_profile_time_zones")?></div>
						</div>
						<div class="profile-table-row">
							<div class="profile-table-col"><?echo GetMessage("main_profile_time_zones_auto")?></div>
							<div class="profile-table-col">
						...
						<div class="profile-table-row">
							<div class="profile-table-col"><?echo GetMessage("main_profile_time_zones_zones")?></div>
							<div class="profile-table-col">
...
<table class="data-table profile-table">
	...
	*/?>
                ...
                <div class="data-table profile-table">
                    ...
                    <div class="profile-table-row">
						...
						<?foreach ($arResult["USER_PROPERTIES"]["DATA"] as $FIELD_NAME => $arUserField):?>
                            <div class="profile-table-row"><div class="field-name">
									<?if ($arUserField["MANDATORY"]=="Y"):?>
                                        <span class="starrequired">*</span>
									<?endif;?>
									<?=$arUserField["EDIT_FORM_LABEL"]?>:</div><div class="field-value">
									<?$APPLICATION->IncludeComponent(
										"bitrix:system.field.edit",
										$arUserField["USER_TYPE"]["USER_TYPE_ID"],
										array("bVarsFromForm" => $arResult["bVarsFromForm"], "arUserField" => $arUserField), null, array("HIDE_ICONS"=>"Y"));?></div></div>
						<?endforeach;?>
                    </div>
                </div>
            </div>
        ...
        <p class="i_marl165"><input type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>"><?/*&nbsp;&nbsp;<input type="reset" value="<?=GetMessage('MAIN_RESET');?>">*/?></p>
    </form>
	<?

...
if ($this->StartResultCache(false, $arParams['CACHE_GROUPS']==='N'? false: $USER->GetGroups()))
{
	...
	$arSelect	= Array('ID','IBLOCK_SECTION_ID','IBLOCK_ID','SECTION_PAGE_URL','DEPTH_LEVEL','UF_LINK','UF_IMG', 'UF_PRODUCT', 'UF_COLUM_MENU', 'UF_NAME', 'UF_IMG', 'UF_IMG_2', 'UF_IMG_WHITE', 'UF_I_NAME_KZ', 'UF_I_NAME_RU', 'UF_I_NAME_EN', 'UF_SUBTITLE_'.$l);

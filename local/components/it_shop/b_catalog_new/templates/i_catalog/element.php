...
<?$ElementID = $APPLICATION->IncludeComponent(
	...
	array(
		...
		'SET_VIEWED_IN_COMPONENT' => 'Y',//(isset($arParams['DETAIL_SET_VIEWED_IN_COMPONENT']) ? $arParams['DETAIL_SET_VIEWED_IN_COMPONENT'] : ''),
...
<?// Для просмотренных товаров, помимо товара в катором находимся
global $I_VIEW_ELEMENT_ID;
$I_VIEW_ELEMENT_ID = $ElementID;?>

				...
				foreach ($arSource as $arProperties)
				{
					...
					elseif ($arProperties["TYPE"] == "TEXT")
					{
						...
						<div class="bx_block r3x1">
							<input type="text" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?if($arProperties['VALUE']!='Untitled' || $arProperties['VALUE']!='<Без имени>')echo $arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" jqajfid="<?=$arProperties['CODE']?>"<?if($arProperties['IS_EMAIL']=='Y')echo ' jqajemail="Y"'?>>

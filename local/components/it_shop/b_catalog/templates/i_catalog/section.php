...
<?$intSectionID = $APPLICATION->IncludeComponent(
	...
	array(
		...
		'I_WATER_MARK_SECTION'	=> $arParams['I_WATER_MARK'],
	...
	$component
		...
		<div class="item_pp fright">
			Товаров на странице:
			<select class="sel">
				<option <?if($count==20)echo 'selected '?>value="20">20</option>
				<option <?if($count==40)echo 'selected '?>value="40">40</option>
				<option <?if($count==60)echo 'selected '?>value="60">60</option>
			</select>
		</div>

	...
	<div class="profile-table data-table">
		<div class="i_pr_last_update">
			...
			?>
				...
				?>
				<div>
                    <span class="i_left_text"><?=GetMessage('LAST_UPDATE')?> </span><?=$arResult["arUser"]["TIMESTAMP_X"]?>
				</div>
				<?
				}
				?>
		...
		<div class="i_pr_body">
			<div class="i_pr_left">
				<?/*
                <div>
					<div><?=GetMessage("main_profile_title")?>:</div>
					<div><input placeholder="<?=GetMessage("main_profile_title")?>" type="text" name="TITLE" value="<?=$arResult["arUser"]["TITLE"]?>" /></div>
				</div>
                */?>
                <div>
					<div><?=GetMessage('NAME')?>:</div>
					<div><input placeholder="<?=GetMessage('NAME')?>" type="text" name="NAME" maxlength="50" value="<?=$arResult["arUser"]["NAME"]?>" /></div>
				</div>
				<div>
					<div><?=GetMessage('LAST_NAME')?>:</div>
					<div><input placeholder="<?=GetMessage('LAST_NAME')?>" type="text" name="LAST_NAME" maxlength="50" value="<?=$arResult["arUser"]["LAST_NAME"]?>" /></div>
				</div>
				<div>
					<div><?=GetMessage('SECOND_NAME')?>:</div>
					<div><input placeholder="<?=GetMessage('SECOND_NAME')?>" type="text" name="SECOND_NAME" maxlength="50" value="<?=$arResult["arUser"]["SECOND_NAME"]?>" /></div>
				</div>
				<div class="i_pr_email">
					<div><?=GetMessage('EMAIL')?><?if($arResult["EMAIL_REQUIRED"]):?>:<span class="starrequired">*</span><?endif?></div>
					<div><input placeholder="<?=GetMessage('EMAIL')?>" type="text" name="EMAIL" maxlength="50" value="<?=$arResult["arUser"]["EMAIL"]?>" /></div>
				</div>
				<?/*<div>
					<div><?=GetMessage('LOGIN')?>:<span class="starrequired">*</span></div>
					<div><input placeholder="<?=GetMessage('LOGIN')?>" type="text" name="LOGIN" maxlength="50" value="<?=$arResult["arUser"]["LOGIN"]?>" /></div>
				</div>*/?>
			</div>
			<div class="i_pr_right">
				<?if($arResult["arUser"]["EXTERNAL_AUTH_ID"] == ''):?>
					<div>
						<div><?=GetMessage('NEW_PASSWORD_REQ')?>:</div>
						<div><input placeholder="<?=GetMessage('NEW_PASSWORD_REQ')?>" type="password" name="NEW_PASSWORD" maxlength="50" value="" autocomplete="off" class="bx-auth-input" />
					...
					<div>
						<div><?=GetMessage('NEW_PASSWORD_CONFIRM')?>:</div>
						<div><input placeholder="<?=GetMessage('NEW_PASSWORD_CONFIRM')?>" type="password" name="NEW_PASSWORD_CONFIRM" maxlength="50" value="" autocomplete="off" /></div>
					</div>
				<?endif?>
			</div>
		<?/*if($arResult["TIME_ZONE_ENABLED"] == true):?>
			<div>
				<div colspan="2" class="profile-header"><?echo GetMessage("main_profile_time_zones")?></div>
			</div>
			<div>

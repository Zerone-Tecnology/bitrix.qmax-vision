...
use Ilab\Core;
Core\CVariablesStorage::set('CIBLockTemplate', 'i_block_top_horizontal');
  // ---------------------------------------------------------------------------------------------------- iLaB?>
...
<div class="i_index_top i_block_top_horizontal">
	<div class="ifleft i_w220" id="jq_get_disc"><!-- Left Block -->
	...
	<div class="ifright i_w700"><!-- Right Block -->

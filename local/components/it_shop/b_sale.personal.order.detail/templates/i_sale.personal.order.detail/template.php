		...
		<div class="sale-order-detail-general">
			...
			<div class="sale-order-detail-payment-options-order-content">
				...
				<div class="sale-order-detail-payment-options-order-content-container">
					<div class="sale-order-detail-payment-options-order-content-title">
											...
											<div class="sale-order-detail-order-item-tr sale-order-detail-order-basket-info sale-order-detail-order-item-tr-first">
												...
												<div class="sale-order-detail-order-item-td sale-order-detail-order-item-properties bx-text-right">
													...
													<div class="sale-order-detail-order-item-td-text">
														<strong class="bx-price"><?=$basketItem['PRICE_FORMATED']?></strong>
													</div>
												</div>
												<?
						...
						<div class="sale-order-detail-about-order-inner-container">
								...
								if ($arParams['GUEST_MODE'] !== 'Y')
								{
									...
									<div class="sale-order-detail-about-order-inner-container-repeat">
										<div class="sale-order-detail-about-order-inner-container-repeat-button-title">
										...
										<div class="sale-order-detail-about-order-inner-container-repeat-button-detail">
											<?
								...
								?>
							<div class="sale-order-detail-about-order-inner-container-slide">
								<a class="sale-order-detail-about-order-inner-container-slide-read-less">
									<span><?= Loc::getMessage('SPOD_LIST_LESS') ?></span>
								</a>
								<a class="sale-order-detail-about-order-inner-container-slide-read-more">
									<span><?= Loc::getMessage('SPOD_LIST_MORE') ?></span>
								</a>
							</div>
							<div class="sale-order-detail-about-order-inner-container-details">
								<h3 class="sale-order-detail-about-order-inner-container-details-title">
								...
								<ul class="sale-order-detail-about-order-inner-container-details-list">
									...
									if (strlen($arResult["USER"]["LOGIN"]) && !in_array("LOGIN", $arParams['HIDE_USER_INFO']))
									{
										...
										<li class="sale-order-detail-about-order-inner-container-list-item">
											<span class="sale-order-detail-about-order-inner-container-list-item-title"><?= Loc::getMessage('SPOD_LOGIN')?>:</span>
									...
									if (strlen($arResult["USER"]["EMAIL"]) && !in_array("EMAIL", $arParams['HIDE_USER_INFO']))
									{
										?>
										<li class="sale-order-detail-about-order-inner-container-list-item">
											<span class="sale-order-detail-about-order-inner-container-list-item-title"><?= Loc::getMessage('SPOD_EMAIL')?>:</span>
									...
									if (strlen($arResult["USER"]["PERSON_TYPE_NAME"]) && !in_array("PERSON_TYPE_NAME", $arParams['HIDE_USER_INFO']))
									{
										?>
										<li class="sale-order-detail-about-order-inner-container-list-item">
											<span class="sale-order-detail-about-order-inner-container-list-item-title"><?= Loc::getMessage('SPOD_PERSON_TYPE_NAME') ?>:</span>
											<div class="sale-order-detail-about-order-inner-container-list-item-element">
									...
									if (isset($arResult["ORDER_PROPS"]))
									{
										foreach ($arResult["ORDER_PROPS"] as $property)
										{
											?>
											<li class="sale-order-detail-about-order-inner-container-list-item">
												<span class="sale-order-detail-about-order-inner-container-list-item-title"><?= htmlspecialcharsbx($property['NAME']) ?>:</span>
												<div class="sale-order-detail-about-order-inner-container-list-item-element">
													<?
									...
									if (strlen($arResult["USER_DESCRIPTION"]))
									{
										?>
										<li class="sale-order-detail-about-order-inner-container-list-item">
											<span class="sale-order-detail-about-order-inner-container-list-item-title"><?= Loc::getMessage('SPOD_ORDER_DESC') ?></span>
											<div class="sale-order-detail-about-order-inner-container-list-item-element">
								...
								<div class="sale-order-detail-payment-options-info">
										...
										<div class="sale-order-detail-payment-options-info-container">
											...
											<div class="sale-order-detail-payment-options-info-total-price">
												<div class="sale-order-detail-payment-options-info-total-price-title"><?=Loc::getMessage('SPOD_ORDER_PRICE_FULL')?>:</div>
												<div class="sale-order-detail-payment-options-info-total-price-detail"><?=$arResult["PRICE_FORMATED"]?></div>
											</div>
										</div>
												...
												<div class="sale-order-detail-payment-options-methods-information-block">
													...
													<div class="sale-order-detail-payment-options-methods-info">
														<div class="sale-order-detail-payment-options-methods-info-title">
															...
															<div class="sale-order-detail-methods-detail">
																<?
																if ($payment['PAID'] === 'Y')
																{
																	?>
														...
														<div class="sale-order-detail-payment-options-methods-info-change-slide">
															<?
															...
															)
															{
																?>
																	...
																	<a href="#" id="<?=$payment['ACCOUNT_NUMBER']?>" class="sale-order-detail-payment-options-methods-info-change-link"><span id="<?=$payment['ACCOUNT_NUMBER']?>"><?=Loc::getMessage('SPOD_CHANGE_PAYMENT_TYPE')?></span></a>
														...
														<div>
															...
															<div class="sale-order-detail-payment-options-methods-shipment-list">
																<div class="sale-order-detail-payment-options-methods-shipment-list-item">
																	...
																	<div class="sale-order-detail-payment-options-methods-shipment-list-item-detail">
																...
																<div class="sale-order-detail-payment-options-methods-shipment-list-item">
																	...
																	<div class="sale-order-detail-payment-options-methods-shipment-list-item-detail">
																		<span class="sale-order-list-<?=($shipment['STATUS_ID']=='DF') ? 'green' : 'orange'?>"><?= htmlspecialcharsbx($shipment['STATUS_NAME'])?></span>
																	</div>
																</div>
																<?
																...
																<?/*<div class="sale-order-detail-payment-options-methods-shipment-list-item-link">
																	<a class="sale-order-detail-show-link"><span><?= Loc::getMessage('SPOD_LIST_SHOW_ALL')?></span></a>
																	<a class="sale-order-detail-hide-link"><span><?= Loc::getMessage('SPOD_LIST_LESS')?></span></a>
																</div>*/?>
															</div>
															<?
														...
														<?/*<div class="sale-order-detail-payment-options-shipment-composition-map">
															...
															?>
																<div class="sale-order-detail-payment-options-shipment-composition-container">
																		<div class="sale-order-detail-payment-options-shipment-composition-title">
			...
			<div class="sale-order-detail-total-payment">
				<div class="sale-order-detail-total-payment-container">
					<ul class="sale-order-detail-total-payment-list">
						<?
						if (floatval($arResult["ORDER_WEIGHT"]))
						{
							?>
							<li class="sale-order-detail-total-payment-list-item">
								<div class="sale-order-detail-total-payment-list-left-item">
									<?= Loc::getMessage('SPOD_TOTAL_WEIGHT')?>:
								</div>
								<div class="sale-order-detail-total-payment-list-right-item">&nbsp;<?= $arResult['ORDER_WEIGHT_FORMATED'] ?></div>
							</li>
							<?
						}
						if ($arResult['PRODUCT_SUM_FORMATED'] != $arResult['PRICE_FORMATED'] && !empty($arResult['PRODUCT_SUM_FORMATED']))
						{
							...
							<li class="sale-order-detail-total-payment-list-item">
								...
								<div class="sale-order-detail-total-payment-list-right-item">&nbsp;<?=$arResult['PRODUCT_SUM_FORMATED']?></div>
							</li>
							<?
						}
						if (strlen($arResult["PRICE_DELIVERY_FORMATED"]))
						{
							...
							<li class="sale-order-detail-total-payment-list-item">
								...
								<div class="sale-order-detail-total-payment-list-right-item">&nbsp;<?= $arResult["PRICE_DELIVERY_FORMATED"] ?></div>
							</li>
							<?
						}
						if ((float)$arResult["TAX_VALUE"] > 0)
						{
							...
							<li class="sale-order-detail-total-payment-list-item">
								...
								<div class="sale-order-detail-total-payment-list-right-item">&nbsp;<?= $arResult["TAX_VALUE_FORMATED"] ?></div>
							</li>
							<?
						}
						?>
						<li class="sale-order-detail-total-payment-list-item">
							<div class="sale-order-detail-total-payment-list-left-item"><?= Loc::getMessage('SPOD_SUMMARY')?>:</div>
							<div class="sale-order-detail-total-payment-list-right-item">&nbsp;<?=$arResult['PRICE_FORMATED']?></div>
						</li>
					</ul>
					<?/*
